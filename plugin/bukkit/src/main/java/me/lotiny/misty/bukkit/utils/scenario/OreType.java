...
public enum OreType {
    ...
    DEEPSLATE_IRON_ORE(
            XMaterial.DEEPSLATE_IRON_ORE, XMaterial.DEEPSLATE_IRON_ORE, XMaterial.RAW_IRON, XMaterial.IRON_INGOT, 1, 1),
    RAW_IRON_BLOCK(
            XMaterial.RAW_IRON_BLOCK, XMaterial.RAW_IRON_BLOCK, XMaterial.RAW_IRON_BLOCK, XMaterial.IRON_BLOCK, 1, 9),

    GOLD_ORE(XMaterial.GOLD_ORE, XMaterial.GOLD_ORE, XMaterial.RAW_GOLD, XMaterial.GOLD_INGOT, 1, 3),
    DEEPSLATE_GOLD_ORE(
            XMaterial.DEEPSLATE_GOLD_ORE, XMaterial.DEEPSLATE_GOLD_ORE, XMaterial.RAW_GOLD, XMaterial.GOLD_INGOT, 1, 3),
    RAW_GOLD_BLOCK(
            XMaterial.RAW_GOLD_BLOCK, XMaterial.RAW_GOLD_BLOCK, XMaterial.RAW_GOLD_BLOCK, XMaterial.GOLD_BLOCK, 1, 27),
    NETHER_GOLD_ORE(
            XMaterial.NETHER_GOLD_ORE, XMaterial.GOLD_NUGGET, XMaterial.GOLD_NUGGET, XMaterial.GOLD_INGOT, 3, 1),
    ...
    DEEPSLATE_COPPER_ORE(
            ...
            XMaterial.DEEPSLATE_COPPER_ORE,
            XMaterial.RAW_COPPER,
            XMaterial.COPPER_INGOT,
            2,
            1),
    RAW_COPPER_BLOCK(
    ...
    DEEPSLATE_REDSTONE_ORE(
            XMaterial.DEEPSLATE_REDSTONE_ORE, XMaterial.REDSTONE, XMaterial.REDSTONE, XMaterial.REDSTONE, 4, 2),
    ...
    DEEPSLATE_DIAMOND_ORE(
            XMaterial.DEEPSLATE_DIAMOND_ORE, XMaterial.DIAMOND, XMaterial.DIAMOND, XMaterial.DIAMOND, 1, 4),

    EMERALD_ORE(XMaterial.EMERALD_ORE, XMaterial.EMERALD, XMaterial.EMERALD, XMaterial.EMERALD, 1, 4),
    DEEPSLATE_EMERALD_ORE(
            XMaterial.DEEPSLATE_EMERALD_ORE, XMaterial.EMERALD, XMaterial.EMERALD, XMaterial.EMERALD, 1, 4);
