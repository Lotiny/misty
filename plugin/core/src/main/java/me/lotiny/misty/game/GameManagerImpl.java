...
import me.lotiny.misty.game.registry.GameRegistryImpl;
...
import me.lotiny.misty.task.AnnounceTask;
import me.lotiny.misty.utils.GoldenHead;
import me.lotiny.misty.utils.KeyEx;
import me.lotiny.misty.utils.PlayerUtils;
import me.lotiny.misty.utils.Snapshot;
import me.lotiny.misty.utils.TeamEx;
import me.lotiny.misty.utils.UHCUtils;
import me.lotiny.misty.utils.Utilities;
import me.lotiny.misty.utils.cooldown.CombatLoggerCooldown;
...
public class GameManagerImpl implements GameManager {
    ...
    private Objective getOrCreateObjective(Scoreboard board) {
        ...
        if (objective == null) {
            objective = NMS.getInstance().registerHealthObjective(board);
        }
        return objective;
    }
