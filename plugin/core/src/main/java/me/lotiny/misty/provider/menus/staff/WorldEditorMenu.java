package me.lotiny.misty.provider.menus.staff;
...
import me.lotiny.misty.provider.menus.MenuItem;
import me.lotiny.misty.provider.menus.MistyMenu;
                        ...
                        (clickedPlayer, clickType) -> {
                            ...
                            if (Bukkit.getWorld(gameManager.getRegistry().getUhcWorld()) == null) {
                                worldManager.createWorld(
                                        gameManager.getRegistry().getUhcWorld(),
        ...
        buttons.put(
                ...
                MenuItem.of(
                        ...
                        (clickedPlayer, clickType) -> {
                            ...
                            World world =
                                    Bukkit.getWorld(gameManager.getRegistry().getUhcWorld());
                            if (world != null) {
                                if (world.getPlayers().isEmpty()) {
                                    ...
                                    clickedPlayer.sendMessage(
                                            CC.RED + "Cannot delete world because there are players on it!");
                                }
                            } else {
                                clickedPlayer.sendMessage(CC.RED + "The UHC world does not exist!");
                            }
        ...
        buttons.put(
                ...
                MenuItem.of(
                        ...
                        (clickedPlayer, clickType) -> {
                            ...
                            worldManager.createWorld(
                                    registry.getUhcWorld(), World.Environment.NORMAL, WorldType.NORMAL);
                            worldManager.createWorld(
                                    registry.getNetherWorld(), World.Environment.NETHER, WorldType.NORMAL);

                            clickedPlayer.sendMessage(
                                    CC.GREEN + "Successfully regenerate game world and nether world!");

                            worldManager.loadWorld(
                                    registry.getUhcWorld(),
                                    gameManager.getGame().getSetting().getBorderSize());
                        }));
                ...
                MenuItem.of(
                        ...
                        (clickedPlayer, clickType) -> {
                            ...
                            if (Bukkit.getWorld(gameManager.getRegistry().getNetherWorld()) == null) {
                                worldManager.createWorld(
                                        gameManager.getRegistry().getNetherWorld(),
        ...
        buttons.put(
                ...
                MenuItem.of(
                        ...
                        (clickedPlayer, clickType) -> {
                            ...
                            World world =
                                    Bukkit.getWorld(gameManager.getRegistry().getNetherWorld());
                            if (world != null) {
                                if (world.getPlayers().isEmpty()) {
                                    worldManager.deleteWorld(
                                            gameManager.getRegistry().getNetherWorld());
                                    ...
                                    clickedPlayer.sendMessage(
                                            CC.RED + "Cannot delete nether because there are players on it!");
                                }
                            } else {
                                clickedPlayer.sendMessage(CC.RED + "The UHC nether does not exist!");
                            }
