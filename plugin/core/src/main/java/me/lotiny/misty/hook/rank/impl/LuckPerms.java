package me.lotiny.misty.hook.rank.impl;

import me.lotiny.misty.hook.rank.IRank;
...
public class LuckPerms implements IRank {
    ...
    private CachedMetaData getMetaData(UUID uuid) {
        ...
        if (queryOptions.isEmpty()) throw new IllegalArgumentException("LuckPerms context could not be loaded");
