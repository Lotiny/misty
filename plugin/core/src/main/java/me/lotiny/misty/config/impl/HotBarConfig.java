...
import me.lotiny.misty.utils.Permission;
    ...
    private Map<Integer, HotBarItem> lobby = Map.of(
            0,
                    new HotBarItem(
                            ...
                            XMaterial.BOOK,
                            "&bGame Configuration",
                            List.of(" ", "&7Right-click to see current", "&7game configuration.", " "),
                            "cmd:config"),
            1,
                    new HotBarItem(
                            ...
                            "&bGame Settings",
                            List.of(" ", "&7Right-click to settings", "&7server configuration.", " "),
                            "cmd:uhc settings"),
            4,
                    new HotBarItem(
                            null,
                            XMaterial.NAME_TAG,
                            "&bStats",
                            List.of(" ", "&7Right-click to see", "&7your uhc stats.", " "),
                            "cmd:stats"),
            7,
                    new HotBarItem(
                            null,
                            XMaterial.EMERALD,
                            "&bLeaderboard",
                            List.of(" ", "&7Right-click to see", "&7server leaderboards.", " "),
                            "cmd:leaderboards"),
            8,
                    new HotBarItem(
                            null,
    ...
    private Map<Integer, HotBarItem> spectator = Map.of(
            0,
                    new HotBarItem(
                            ...
                            XMaterial.COMPASS,
                            "&dSpectator Compass",
                            List.of(" ", "&7Right-click to see", "&7all players in game.", " "),
                            "act:alive-players"),
            1,
                    new HotBarItem(
                            Permission.HOST_PERMISSION,
                            ...
                            List.of(" ", "&7Right-click to teleport", "&7to random player in-game.", " "),
            ...
            4,
                    new HotBarItem(
                            ...
                            "&fBetter View",
                            List.of(" ", "&7Holding this to get better-view.", " "),
                            null),
            5,
                    new HotBarItem(
                            null,
                            XMaterial.EMERALD,
                            "&aTeleport To Center",
                            List.of(" ", "&7Right-click to teleport", "&7to the center of uhc world.", " "),
                            "act:teleport-center"),
            8,
                    new HotBarItem(
                            Permission.HOST_PERMISSION,
                            ...
                            List.of(" ", "&7Right-click player to", "&7inspect inventory.", " "),
